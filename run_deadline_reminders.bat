@echo off
cd /d E:\Job_Portal
E:\Job_Portal\.venv\Scripts\python.exe manage.py close_expired_jobs >> E:\Job_Portal\cron_log.txt 2>&1
E:\Job_Portal\.venv\Scripts\python.exe manage.py send_deadline_reminders >> E:\Job_Portal\cron_log.txt 2>&1
